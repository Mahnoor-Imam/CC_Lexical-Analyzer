...
public class Lexer {
    ...
    public static void main(String[] args) throws IOException {
        filename = args[0];     //getting filename which is passed as argument to main
        initKeywords();
        ...
        System.out.println("\nExecution successful! Check the generated tokens in tokens.txt");     //success message(no error scenario)
